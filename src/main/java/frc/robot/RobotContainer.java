...
*/
  ...
  public Command getAutonomousCommand() {
    ...
    new indexerCommand(indexerSub, Constants.indexerSpeed).withTimeout(2));

    SequentialCommandGroup shooting = new SequentialCommandGroup(  
      new shooterCommand(shooterSub, .5).withTimeout(2), new WaitCommand(1), flywheel.withTimeout(5));
    SequentialCommandGroup auto = new SequentialCommandGroup(
      shooting, new WaitCommand(5), new encoderMove(driveSub, Constants.tarmacDistance));
    return auto;
  }
}
